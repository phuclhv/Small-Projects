...
class UserTest < ActiveSupport::TestCase
  ...
  # The new @user is valid
  test "should be valid" do
    assert @user.valid?
  end

  # First name should be there
  ...
  # Last name should be 30 characters or less
  test "last name should not be too long" do
    @user.last_name = "a" * 31
    assert_not @user.valid?
  end

  # First name should be 30 characters or less
  ...
  test "full name should be valid" do
